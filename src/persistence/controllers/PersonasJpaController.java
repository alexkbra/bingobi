...
public class PersonasJpaController implements Serializable {
    ...
    public void create(Personas personas) {
        ...
        try {
            ...
            TipoDocumento idTipodocumento = personas.getIdTipodocumento();
            if (idTipodocumento != null) {
                idTipodocumento = em.getReference(idTipodocumento.getClass(), idTipodocumento.getId());
                personas.setIdTipodocumento(idTipodocumento);
            }
            ...
            em.persist(personas);
            if (idTipodocumento != null) {
                idTipodocumento.getPersonasList().add(personas);
    ...
    public void edit(Personas personas) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            TipoDocumento idTipodocumentoOld = persistentPersonas.getIdTipodocumento();
            TipoDocumento idTipodocumentoNew = personas.getIdTipodocumento();
            ...
            if (idTipodocumentoNew != null) {
                ...
                personas.setIdTipodocumento(idTipodocumentoNew);
            }
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            TipoDocumento idTipodocumento = personas.getIdTipodocumento();
            if (idTipodocumento != null) {
                idTipodocumento.getPersonasList().remove(personas);
                idTipodocumento = em.merge(idTipodocumento);
            }
